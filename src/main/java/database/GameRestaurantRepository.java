...
public class GameRestaurantRepository {
    ...
    public boolean hasGameRestaurant(GameRestaurant gameRestaurant, int locationId, Connection conn) throws Exception {
        String query = "SELECT * from game_restaurants where name = ? and url=? and location_id=?";
